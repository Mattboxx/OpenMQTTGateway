...
| MQTT resilience | Standard reconnect behaviour | Unique client ID suffix, uninterrupted WiFi association window, protected recovery portal, bounded MQTT reconnect timing, longer keepalive, preserved operation while the broker is offline and safer password updates |
...
* [Custom prerelease firmware](https://github.com/Mattboxx/OpenMQTTGateway/releases/tag/v1.8.1-wol-multi-gpio.6)
